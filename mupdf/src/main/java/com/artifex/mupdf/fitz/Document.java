...
public class Document {
    ...
    /**
     * fix: libc    : FORTIFY: pthread_mutex_lock called on a destroyed mutex (0xd4550a60)
     * @param filename 文件路径
     * @param options 其它选项参数
     */
    public native void saveDoc(String filename, String options);
