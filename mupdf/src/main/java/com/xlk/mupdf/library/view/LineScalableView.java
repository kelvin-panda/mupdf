 ...
 * 可拖动缩放的签名控件
 */
public class LineScalableView extends View implements View.OnTouchListener {
     ...
     */
    public LineScalableView(Context context, List<SignatureBoard.DrawPath> drawPaths,
    ...
    private void initPaint() {
        ...
        dottedLinePaint.setStrokeWidth(1);// 画笔宽度
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (isZoomEnabled) {
                    ...
                    if (dx != 0 || dy != 0) {
                        ...
                        float newWidth;
                        float newHeight = layoutParams.height;
                        if (isMoveXMore) {
    ...
    private boolean checkSize(float newWidth, float newHeight) {
        ...
        if (newWidth < 100 || newHeight < 30) return false;
        return true;
    }
}