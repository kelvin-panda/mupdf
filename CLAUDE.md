...
Android library project wrapping MuPDF for PDF document rendering with annotation, signature, screenshot, and watermark features. Published via JitPack as `com.gitee.xlk_gitee:mupdf-library:6.0.19`.
...
- Version defined in `mupdf/build.gradle` `version = '6.0.19'`.
